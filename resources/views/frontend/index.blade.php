                        ...
                        <div class="trending-tittle">
                            ...
                            <div class="trending-animated">
                                <ul id="js-news" class="js-hidden">
                                    <li class="news-item">{{$detail->trendnews}}</li>
                                    <li class="news-item">{{$detail->trendnews}}</li>
                                    <li class="news-item">{{$detail->trendnews}}</li>
                                </ul>
                            </div>
                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    ...
                                    <h2><a href="{{url('frontend-details')}}">{{$detail->newshead}}</a></h2>
                                </div>
                            </div>
                        </div>
                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="single-bottom mb-35">
                                    ...
                                    <div class="trend-bottom-cap">
                                        ...
                                        <h4><a href="{{url('frontend-details')}}">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4>
                                    </div>
                                </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><h4><a href="{{url('frontend-details')}}">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="{{url('frontend-details')}}"> Welcome To The Best Model Winner Contest</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
